...
## Final Capstone Shiny Project
## Author: Raja Jayaraman

# SHINY SERVER 
library(shiny); library(stringr); library(tm)

# Load the bigram, trigram and quadgram frequencies words matrix frequencies
...
## This function will predict the next word
...
## The shiny server code to call the function predictWord
